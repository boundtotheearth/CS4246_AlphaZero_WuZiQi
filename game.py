...
"""
@author: Junxiao Song
Modified From: https://github.com/junxiaosong/AlphaZero_Gomoku
"""
...
class Board(object):
    ...
    def current_state(self):
        ...
        square_state = torch.zeros((4, self.width, self.height), dtype=torch.float)
        if self.states:
...
class Game(object):
    ...
    def graphic(self, board, player1, player2):
        ...
        print(self.board.get_current_player())
    ...
    def start_self_play(self, player, is_shown=0, temp=1.0):
        ...
        while True:
            move, move_probs = player.get_action(self.board, return_prob=True, temp=temp)
            # store the data
